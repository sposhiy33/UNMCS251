...
public class GameManager {
    ...
    private List<int[]> emptyIndicies = new ArrayList<int[]>();
    private List<int[]> wallIndicies = new ArrayList<int[]>();
    private List<int[]> foodIndicies = new ArrayList<int[]>();
    ...
    /**
     * returns a string represention of the level state, contrstructed from
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < 6; i++) { 
            ...
            System.out.println(board.toString());
            System.out.println(board.currentState);
            System.out.println(" ");
        }
    }
